...

{
    ...
    switch (userSelectionMenu) //to be able to choose a number, Ref: https://stackoverflow.com/questions/43484523/switch-statements-for-a-menu-c
    {
        ...
        case 1: //Client Menu
            ...
            else if (userSelectionClientMenu >= 5)
            {
                goto default; //ref. https://www.xsprogram.com/content/how-to-jump-to-another-case-statement-in-a-switch-case-condition-with-the-value.html
            }
...
static void Zones()
{
    ...
    Console.WriteLine("Go back to Client menu [4]");
